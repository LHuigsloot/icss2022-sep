...
public class ICSSParser extends Parser {
	...
	public static final int
		...
		RULE_declaration = 7, RULE_variableAssignment = 8, RULE_variableReference = 9, 
		RULE_expression = 10, RULE_styleRule = 11, RULE_selector = 12, RULE_tagSelector = 13, 
		RULE_idSelector = 14, RULE_classSelector = 15, RULE_properties = 16, RULE_propertyName = 17, 
		RULE_ifClause = 18, RULE_elseClause = 19;
	private static String[] makeRuleNames() {
		return new String[] {
			"stylesheet", "colorLiteral", "percentageLiteral", "pixelLiteral", "boolLiteral", 
			"scalarLiteral", "literal", "declaration", "variableAssignment", "variableReference", 
			"expression", "styleRule", "selector", "tagSelector", "idSelector", "classSelector", 
			"properties", "propertyName", "ifClause", "elseClause"
		};
	}
	...
	public final TagSelectorContext tagSelector() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_tagSelector);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(112);
